...
type Album struct {
	...
	Updated         	int     	`db:"updated" bson:"updated" comment:"编辑时间" json:"updated" xml:"updated"`
	Views           	int     	`db:"views" bson:"views" comment:"浏览次数" json:"views" xml:"views"`
	Comments        	int     	`db:"comments" bson:"comments" comment:"评论次数" json:"comments" xml:"comments"`
	Likes           	int     	`db:"likes" bson:"likes" comment:"喜欢次数" json:"likes" xml:"likes"`
	Display         	string  	`db:"display" bson:"display" comment:"显示" json:"display" xml:"display"`
	Deleted         	int     	`db:"deleted" bson:"deleted" comment:"删除时间" json:"deleted" xml:"deleted"`
