...
type Attathment struct {
	...
	Name           	string  	`db:"name" comment:"文件名" json:"name" xml:"name"`
	Path           	string  	`db:"path" comment:"保存路径" json:"path" xml:"path"`
	Extension      	string  	`db:"extension" comment:"扩展名" json:"extension" xml:"extension"`
	Type           	string  	`db:"type" comment:"文件类型" json:"type" xml:"type"`
	Size           	int64   	`db:"size" comment:"文件尺寸" json:"size" xml:"size"`
	...
	Audited        	int     	`db:"audited" comment:"审核时间" json:"audited" xml:"audited"`
	RcId           	int     	`db:"rc_id" comment:"关联id" json:"rc_id" xml:"rc_id"`
