...
type Attathment struct {
	...
	Size           	int64   	`db:"size" bson:"size" comment:"文件尺寸" json:"size" xml:"size"`
	...
	Audited        	int     	`db:"audited" bson:"audited" comment:"审核时间" json:"audited" xml:"audited"`
	RcId           	int     	`db:"rc_id" bson:"rc_id" comment:"关联id" json:"rc_id" xml:"rc_id"`
