...
type User struct {
	...
	Id             	int     	`db:"id,omitempty,pk" bson:"id,omitempty" comment:"UID" json:"id" xml:"id"`
	...
	LoginTime      	int     	`db:"login_time" bson:"login_time" comment:"上次登录时间" json:"login_time" xml:"login_time"`
