...
func templateDbschemaGotpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dbschema.gotpl", size: 17756, mode: os.FileMode(420), modTime: time.Unix(1731218804, 0)}
