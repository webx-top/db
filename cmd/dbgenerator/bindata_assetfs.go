...
func templateDbschemaGotpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dbschema.gotpl", size: 16044, mode: os.FileMode(420), modTime: time.Unix(1659254940, 0)}
