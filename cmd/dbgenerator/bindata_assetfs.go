...
func templateDbschemaGotpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dbschema.gotpl", size: 12730, mode: os.FileMode(420), modTime: time.Unix(1621656188, 0)}
