...
func templateDbschemaGotpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/dbschema.gotpl", size: 15491, mode: os.FileMode(420), modTime: time.Unix(1643013964, 0)}
