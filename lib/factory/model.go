...
type Model interface {
	...
	Add() (interface{}, error)
	Save(mw func(db.Result) db.Result, args ...interface{}) error
	Savex(mw func(db.Result) db.Result, args ...interface{}) (affected int64, err error)
	SaveByFields(mw func(db.Result) db.Result, fields []string, args ...interface{}) (err error)
	SavexByFields(mw func(db.Result) db.Result, fields []string, args ...interface{}) (affected int64, err error)
	...
	SaveField(mw func(db.Result) db.Result, field string, value interface{}, args ...interface{}) error
	SaveFields(mw func(db.Result) db.Result, kvset map[string]interface{}, args ...interface{}) error
	SaveValues(mw func(db.Result) db.Result, keysValues *db.KeysValues, args ...interface{}) error
